...
namespace Logic 
{
	...
	bool CEntity::HandleMessage(const ToggleMessage& msg)
	{
		SEND_MESSAGE_TO_ALL_COMPONENTS;
	}

	bool CEntity::HandleMessage(const PowerMessage& msg)
	{
		SEND_MESSAGE_TO_ALL_COMPONENTS;
	}

	bool CEntity::HandleMessage(const ConsumptionMessage& msg)
	{
		SEND_MESSAGE_TO_ALL_COMPONENTS;
	}
	...
	bool CEntity::HandleMessage(const SoundMessage& msg)
	{
		SEND_MESSAGE_TO_ALL_COMPONENTS;
	}

	bool CEntity::HandleMessage(const ParticleMessage& msg)
	{
		SEND_MESSAGE_TO_ALL_COMPONENTS;
	}
