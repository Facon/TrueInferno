...
namespace Logic
{
	...
	*/
	...
	public:
		...
		Constructor.
		*/
		CSoulSpeedAlterationEvent(unsigned long time, float factor = 0.25, int duration = 10, bool absoluteTime = true, bool restore = false) :
...
#endif // SOULS_SPEED_ALTERATIONsa_EVENT_H_
