...
namespace Graphics 
{
		...
		: _scene(0), _targetNode(nullptr)
	{
		...
		// Rotación en X para mirar hacia abajo
		_camera->rotate(Vector3(1.0f, 0.0f, 0.0f), Ogre::Degree(-45.0f));

		// #perspectiva Rotación en Y para perspectiva isométrica. Comentar
		// para volver a ortogonal
		_camera->rotate(Vector3(0.0f, 1.0f, 0.0f), Ogre::Degree(45.0f));
